<div class="row">
			<ol class="breadcrumb">
				...
				<li class="active">Management Type</li> <small>Edit</small>
			</ol>
</div><!--/.row-->
<br />
...
<br />
	...
	<section class="content ">
		...
		<div class="row">
                        <div class="col-sm-6">
                            <a class="btn btn-primary" href="<?php echo  base_url('admin/type'); ?>" role="button"><i class="fa fa-hand-o-left"></i> Back</a>
